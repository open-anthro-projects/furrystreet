      ...
      <Grid item className={classes.cover_image}>
        ...
        <AppBar position="sticky" className={classes.appBar} elevation={0} color="default">
            ...
            <div className={classes.tabs}>
              <Tabs value={value}  onChange={handleChange} aria-label="simple tabs example" textColor="inherit" color="inherit">
                <Tab label="Home" className={classes.hover} underline="none" {...a11yProps(0)} component={Link} href="/post-office" textColor="inherit" color="inherit"/>
                <Tab label="FAQ" className={classes.hover} underline="none" {...a11yProps(1)} component={Link} href="/post-office/faq" textColor="inherit" color="inherit"/>
              </Tabs>
            </div>  
            </Toolbar>
        </AppBar>
